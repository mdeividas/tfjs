...
export default class Obstacle {
    ...
    constructor(props: IParams, context: CanvasRenderingContext2D) {
        ...
        this.#passGate = Obstacle.getPassGatePosition(this.#size, this.#params.totalHeight - this.#size - this.#size);
    ...
    draw() {
        ...
        this.#dimensions.forEach((dimention) => {
            this.#context.rect(dimention.x, dimention.y, dimention.width, dimention.height);
        });
