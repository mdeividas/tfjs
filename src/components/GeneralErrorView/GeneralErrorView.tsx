...
export const GeneralErrorView: React.FC<IProps> = (props) => (
    <>
        <div role="alert" className="mt-8">
            <div className="bg-red-500 text-white font-bold rounded-t px-4 py-2">Something when wrong</div>
            <div className="border border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700">
                <p>Error message: {props.error}</p>
                <p>
                    Apologies for the inconvenience. Please try reloading the page, visit again later, or contact me for
                    further assistance.
                </p>
        ...
        <h3 className="text-3xl mt-8 mb-3 font-bold text-center uppercase">It might help you</h3>
        <div role="alert" className="mt-8">
